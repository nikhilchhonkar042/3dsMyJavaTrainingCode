public class DsgsLoginData {
    public static void main(String[] args) {
        ...
        dsgs1.changeUserPasseord(12345678L);
        dsgs1.currentAccountBalance(0456464L);
        dsgs1.showiMyIfsc();
...
class BankCustomer {
    ...
    // Constructor to initialize the fields Constructor number 1 ....
    ...
    /*
    // Constructor to initialize the fields Constructor number 2 ....
    public BankCustomer(String name, int id, String trigram, String bankName,
                        String accountNum, int dob, long accountBalance, long password) {
        this.name = name;
        this.id = id;
        this.trigram = trigram;
        this.bankName = bankName;
    ...
    // Constructor 
    void changeUserPasseord(long newPassword) { //type 2 , with argument no return type 
    	System.out.println("Password change succ");
    	password = newPassword;
    	System.out.println("Thank you user ");
    	System.out.println("<------------------------------------>");
    }
    long currentAccountBalance (long password) { // 3nd type | with argument | with return
    ...
    String showiMyIfsc() { //4th type | with out argument | with return
